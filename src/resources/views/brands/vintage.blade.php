    ...
    <div class="table-responsive mt-4">
        <table class="table text-center mb-0 vintage-table">
            ...
            <tbody>
                ...
                <tr style="cursor: pointer;" onclick="window.location='{{ route('model', ['brandSlug' => $brand->slug, 'typeSlug' => $type->slug, 'vintageSlug' => $vintage->slug ])}}'">
                    <td>{{ $vintage->name }}</td>
                ...
                @empty
                <tr>
                    <td colspan="3">Nincs elérhető vintage adat ennél a típusnál.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
