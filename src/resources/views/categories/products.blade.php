                ...
                @if(isset($subcategory))
                    <li class="breadcrumb-item">
                        <a href="{{ !empty($productCategory)
                            ? route('termekcsoport_brand', ['category' => $category->slug, 'subcategory' => $subcategory->slug, 'productCategory' => $productCategory->slug])
                            : route('termekcsoport_dynamic', ['category' => $category->slug, 'subcategory' => $subcategory->slug])
                ...
                @if(!empty($productCategory))
                    <li class="breadcrumb-item">
                        <a href="{{ route('termekcsoport_dynamic_pc', [
                            ...
                            'brandSlug' => $brand->slug ?? $rareBrand->slug
                        ]) }}" class="stretched-link">
                ...
                <div class="card mb-3 shadow-sm p-3">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-3 text-center">
                            <img src="{{ asset('storage/' . ($product->image ?? 'images/no-image.png')) }}" 
                                 alt="{{ $product->name }}" 
