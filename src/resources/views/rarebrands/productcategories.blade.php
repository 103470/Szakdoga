...
<div class="body-container my-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('alkategoria', ['brandSlug' => $rareBrand->slug, 'typeSlug' => $type->slug, 'vintageSlug' => $vintage->slug, 'modelSlug' => $model->slug, 'categorySlug' => $category->slug]) }}">{{ $category->name }}</a>
                </li>
    ...
    <div class="d-flex align-items-center mb-3">
        <h2 class="border-start border-4 theme-blue-border ps-3 mb-1">
            ...
            {{ $model->unique_code }} {{ $category->name }} {{ $subcategory->name }}
        </h2>
    </div>
