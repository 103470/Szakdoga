describe('BMW full navigation to specific category', () => {
  it('navigates from BMW -> type 3 -> specific vintage -> specific model -> fék mechanika', () => {
    cy.visit('/')
    ...
    cy.get('.type-card', { timeout: 20000 }).should('have.length.greaterThan', 0)
