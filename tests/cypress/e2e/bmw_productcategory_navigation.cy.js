describe('BMW full navigation to product category', () => {
  it('navigates from BMW -> type 3 -> vintage -> model -> fék mechanika -> fékbetét -> Beépítési oldal: elsőtengely', () => {
    cy.visit('/')
    ...
    cy.url({ timeout: 30000 }).should('include', '/bmw/3/3_e46_1997_12_2005_05/5405287/fek_mechanika/fekbetet/beepitesi_oldal_elsotengely')
  })
})
